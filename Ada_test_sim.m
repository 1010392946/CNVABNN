...
data6=load('\SimulationData_mat\0.4_6x_mat\sim1_6_6100_read_trains.mat');
...
for temp= covery
    for temp2=purity
        for i=1:sample
            %导入测试样本数据
            data=load(['\tests\SimulationData_mat\0.',num2str(temp),'_',num2str(temp2),'x_mat\sim', num2str(i) ,'_',num2str(temp2),'_',num2str(temp2),'100_read_trains.mat']);
        ...
        %保存边界信息
        save(['\figure\boundary_0.',num2str(temp),'_',num2str(temp2),'.mat'],'boundary')
    end
end